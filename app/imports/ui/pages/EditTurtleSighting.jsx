...
class EditTurtleSighting extends React.Component {
  ...
  submit(data) {
    ...
    TurtleReport.collection.update(_id, { $set: { date, time, animalName, name, phone, location, latitude, longitude, description, markers, numPeople, image, Submit } }, (error) => (error ?
  ...
  renderPage() {
    ...
    return (
      <Grid container centered>
        <Grid.Column>
          <Header as="h2" textAlign="center">Edit Sea Turtle Sighting</Header>
