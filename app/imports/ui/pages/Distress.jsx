        ...
        <Grid.Row verticalAlign='middle' style={{ backgroundImage: `url(${Background})`,
          ...
          <Grid.Column width={14}>
            ...
            <Header as="h3" style={{ color: 'white' }}>If the animal is in distress, it is preferable to call HMAR
              so they can attend to the animal as soon as possible <a className="white-link" href="tel:[888-256-9840]">(888) 256-9840</a>. However, if you cannot call, please fill out the online reporting form.</Header>
            <hr/>
